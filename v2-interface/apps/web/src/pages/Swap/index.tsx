...
export function Swap({
  ...
  return (
    <MultichainContextProvider initialChainId={initialInputChainId ?? DEFAULT_CHAIN_ID}>
...
const SWAP_TABS: readonly SwapTab.Swap[] = [SwapTab.Swap]

const TAB_TYPE_TO_LABEL: Record<SwapTab.Swap, (t: AppTFunction) => string> = {
