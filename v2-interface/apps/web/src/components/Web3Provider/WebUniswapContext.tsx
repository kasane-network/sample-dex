...
import { useNavigateToNftExplorerLink } from 'uniswap/src/features/collectibles/hooks/useNavigateToNftExplorerLink'
...
function WebUniswapProviderInner({ children }: PropsWithChildren) {
  ...
  const navigateToExternalProfile = useCallback(
    ({ address }: { address: Address }) => {
      ...
      navigate(`/portfolio/tokens?address=${address}`)
      closeSearchModal()
    },
    [navigate, closeSearchModal],
  )
