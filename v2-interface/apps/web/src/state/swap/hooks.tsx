...
export function useInitialCurrencyState(): {
  ...
  const supportedChainId = useSupportedChainId(parsedCurrencyState.chainId ?? defaultChainId) ?? DEFAULT_CHAIN_ID
  ...
  const { initialInputCurrencyAddress, initialChainId } = useMemo(() => {
    ...
    return {
      initialInputCurrencyAddress: parsedCurrencyState.outputCurrencyAddress ? undefined : NATIVE_CHAIN_ID,
      initialChainId: parsedCurrencyState.chainId ? supportedChainId : undefined,
    }
  }, [
