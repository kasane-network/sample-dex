...
import { ImageUri } from 'uniswap/src/features/collectibles/images/ImageUri'
import { NFTViewer } from 'uniswap/src/features/collectibles/images/NFTViewer'
...
export function LogoWithTxStatus(props: LogoWithTxStatusProps): JSX.Element {
  ...
  if (chainId && chainId !== UniverseChainId.Kasane) {
...
export function DappLogoWithWCBadge({
  ...
  return (
    <Flex centered height={totalSize} width={totalSize}>
      ...
      {chainId && chainId !== UniverseChainId.Kasane ? (
