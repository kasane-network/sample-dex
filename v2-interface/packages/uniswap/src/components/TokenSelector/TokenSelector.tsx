...
export function TokenSelectorContent({
  ...
  const { onChangeText, searchFilter, chainFilter, parsedChainFilter, parsedSearchFilter } = useFilterCallbacks(
    chainId ?? null,
    flowToModalName(flow),
  )
      ...
      <Trace logImpression element={currencyFieldName} section={SectionName.TokenSelector}>
        <Flex grow gap="$spacing8" style={scrollbarStyles}>
          ...
          <SearchTextInput
            ...
            endAdornment={
              hasClipboardString ? <PasteButton inline textVariant="buttonLabel3" onPress={handlePaste} /> : undefined
            }
