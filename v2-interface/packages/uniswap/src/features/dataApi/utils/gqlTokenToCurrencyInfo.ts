...
export type GqlTokenToCurrencyInfoToken = Omit<NonNullable<NonNullable<BackendApi.TokenQuery['token']>>, 'project'> & {
  project?: Omit<NonNullable<NonNullable<BackendApi.TokenQuery['token']>['project']>, 'tokens'>
}
