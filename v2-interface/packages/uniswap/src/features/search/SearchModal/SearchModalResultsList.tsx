...
function useSectionsForSearchResults({
  ...
  const nftSearchResultsData = undefined
  const searchNftResultsLoading = false
  const searchNftResultsError = undefined
  const refetchSearchNftResults = async () => undefined
  void skipNftSearchQuery
