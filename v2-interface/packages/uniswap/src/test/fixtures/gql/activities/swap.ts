...
export const swapOrderDetails = createFixture<BackendApi.SwapOrderDetails>()(() => ({
  ...
  status: randomEnumValue(BackendApi.SwapOrderStatus),
  swapOrderStatus: randomEnumValue(BackendApi.SwapOrderStatus),
  encodedOrder: faker.datatype.string(),
  swapOrderType: BackendApi.SwapOrderType.Dutch,
}))
