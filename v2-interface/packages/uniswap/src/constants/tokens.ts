...
import { KASANE_CHAIN_INFO } from 'uniswap/src/features/chains/evm/info/kasane'
...
export const { USDC: USDC_KASANE } = KASANE_CHAIN_INFO.tokens
export const TEST_ETH_KASANE = new Token(
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [UniverseChainId.Kasane]: new Token(
    UniverseChainId.Kasane,
