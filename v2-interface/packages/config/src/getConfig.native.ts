...
export const getConfig = (): Config => {
   ...
   * - Mobile ENV vars: must have process.env.<var_name>
   */
  const config: Config = {
    ...
    blockaidProxyUrl: process.env.BLOCKAID_PROXY_URL || '',
    ...
    enableEntryGatewayProxy: process.env.ENABLE_ENTRY_GATEWAY_PROXY === 'true',
    enableSessionService: process.env.ENABLE_SESSION_SERVICE === 'true',
    enableSessionUpgradeAuto: process.env.ENABLE_SESSION_UPGRADE_AUTO === 'true',
