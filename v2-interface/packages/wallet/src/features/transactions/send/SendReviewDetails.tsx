...
import { NFTTransfer } from 'uniswap/src/features/collectibles/NFTTransfer'
...
import { getNftTokenAddress } from 'wallet/src/features/transactions/send/utils/getNftTokenAddress'
...
export function SendReviewDetails({
  ...
  const transferNFTCallback = useSendNFTCallback({
    ...
    chainId: chainId as UniverseChainId,
    toAddress: recipient,
    tokenAddress: getNftTokenAddress(nftIn),
