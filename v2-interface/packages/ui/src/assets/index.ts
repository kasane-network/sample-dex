...
export const ICP_LOGO = require('./logos/png/icp-logo.png')
...
export const SOLANA_BANNER_DARK = require('./backgrounds/solana-banner-light.png')
...
export const SMART_WALLET_UPGRADE_VIDEO = require('./videos/dark-etching.mp4')
