...
describe(uriToHttpUrls, () => {
  ...
  it('allows vite dev server fs urls without allowLocalUri', () => {
    expect(uriToHttpUrls('/@fs/Users/dev/project/packages/ui/src/assets/logos/png/eth-logo.png')).toEqual([
      '/@fs/Users/dev/project/packages/ui/src/assets/logos/png/eth-logo.png',
    ])
  })
})
